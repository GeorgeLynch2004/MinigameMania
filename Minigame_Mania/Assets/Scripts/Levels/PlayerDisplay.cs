...
// {
//     [SerializeField] private NetworkVariable<List<GameObject>> m_Players;
...
//         m_Players.Value = m_GameManager.GetLastMinigamesPositions();
//         // then we want to assign the players positions to the transform positions array
//         for (int i = 0; i < m_Players.Value.Count; i++)
//         {
//             m_Players.Value[i].transform.position = m_Positions[i].position;
//         }
